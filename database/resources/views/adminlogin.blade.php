       ...
       <form action="" method="post">
        ...
        <ul class="list-unstyled" style="font-size: 20px;color: rgb(247, 252, 247);">
          ...
          <tr>
              ...
              <td><input name="usname" type="text" class="form-control" placeholder="user name"></td>
          </tr>
          <tr>
              <td> <ul class="list-unstyled" style="font-size: 20px;color: rgb(247, 252, 247);">Password</ul></td>
              <td><input name="upass" type="password" class="form-control" placeholder="password"></td>
          </tr>
             ...
             <tr>
              <td></td>
              <td> <a href="/fiction" class="btn btn-primary"> <ul class="list-unstyled" style="font-size: 20px;color: rgb(247, 252, 247);"><button class="btn btn-secondary" type="submit" name="btnlog">Login</ul></a></button></td>
          </tr>
