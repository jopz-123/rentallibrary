...
<body background="https://i0.wp.com/codemyui.com/wp-content/uploads/2017/02/android-marshmallow-boot-animation.gif?fit=880%2C440&ssl=1" style="height:100%; background-position: center; background-repeat: https://images.unsplash.com/photo-1553941884-f8947df6e0ba?ixid=MnwxMjA3fDB8MHxwaG90by1no-repeat; background-size: cover;">
...
<div class="container">
    ...
    <table  class="table table-borderless " style="margin-left:300px">
        ...
        <td><select required class="form-select"  aria-label="Default select example" name="ddl"id="ip2" >
